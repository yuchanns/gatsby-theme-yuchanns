...
const Profile = () => {
  const { card } = useSiteMetadata()
  return (
    <div className={styles.cardProfile}>
      <div className={styles.cardProfileContainer}>
        <ul className={styles.cardDetails}>
          {card.hasOwnProperty('location') &&
          <li className={styles.cardDetail}>
            ...
            <span className={styles.cardLabel}>{card.location}</span>
          </li>}
          {card.hasOwnProperty('mail') &&
          <li className={styles.cardDetail}>
            ...
            <span className={styles.cardLabel}>{card.mail}</span>
          </li>}
          {card.hasOwnProperty('job') &&
          <li className={styles.cardDetail}>
            ...
            <span className={styles.cardLabel}>{card.job}</span>
          </li>}
        </ul>
      </div>
    </div>
